          ...
          <div className="flex flex-col md:flex-row gap-2">
            ...
            <div className="relative flex-1" ref={dropdownRef}>
              ...
              >
                ...
                <ChevronDown size={20} className={`text-slate-400 ${isDropdownOpen ? 'rotate-180' : ''}`} />
              </button>
                  ...
                  {MAIN_CATEGORIES.map((cat: any) => {
                    ...
                    return (
                      <button
                        ...
                        className="w-full px-4 py-3 flex items-center gap-3 hover:bg-emerald-50"
                      >
                        <div className={`p-2 rounded-lg ${cat.color} bg-opacity-10`}>
                          <Icon size={18} />
                        </div>
                        <span className="text-sm font-bold">{cat.hindi}</span>
                      </button>
                    );
                  })}
                </div>
          ...
          <div className="flex flex-col md:flex-row gap-2">
            ...
            <div className="flex-grow relative">
              ...
              <input
                ...
                className="w-full h-14 pl-12 pr-4 bg-slate-50 border-2 rounded-2xl"
              />
            </div>
            ...
            <button
              onClick={onSearch}
              disabled={isLoading}
              className="h-14 px-8 bg-emerald-600 text-white rounded-2xl flex items-center justify-center gap-2"
            >
              {isLoading ? "Loading..." : (
                <>
                  <Search size={20} />
