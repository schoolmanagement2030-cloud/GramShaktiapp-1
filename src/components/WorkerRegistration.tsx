...
export default function WorkerRegistration() {
  ...
  const captureLocation = () => {
    ...
    if (!navigator.geolocation) {
      alert('Geolocation is not supported by your browser. / आपके ब्राउज़र द्वारा जियोलोकेशन समर्थित नहीं है।');
      setIsLoading(false);
      return;
    }
  ...
  if (!user) {
    return (
      <div className="bg-white p-8 rounded-2xl shadow-md border border-slate-100 text-center">
        ...
        <p className="text-slate-600 mb-6">Sign in with Google to create your worker profile. / अपना प्रोफाइल बनाने के लिए Google से साइन इन करें।</p>
        <button
      ...
      <AnimatePresence mode="wait">
        {isSuccess ? (
          ...
          >
            ...
            <p className="text-slate-600 mb-8">Your profile is now live. / आपकी प्रोफ़ाइल अब लाइव है।</p>
            <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="flex items-center gap-2 text-sm font-semibold text-slate-700">
                  <UserIcon size={16} /> Name / Shop Name (नाम / दुकान का नाम)
                </label>
                <input
                  required
                  type="text"
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-dashed border-slate-300">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="text-center md:text-left">
                  ...
                  <p className="text-sm text-slate-500">Required to show you to nearby customers. / आस-पास के ग्राहकों को दिखाने के लिए आवश्यक है।</p>
                </div>
                <button
                  type="button"
