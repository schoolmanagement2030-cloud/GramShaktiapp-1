...
export default function WorkerRegistration() {
  ...
  const [isSkillsOpen, setIsSkillsOpen] = useState(false); // Skills dropdown state
  ...
  const filteredSkills = CATEGORIES.filter(
    skill => skill.mainCategoryId === selectedMainCat?.id
  );
        ...
        {isSuccess ? (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Skills/Sub-category Dropdown (Modified Section) */}
